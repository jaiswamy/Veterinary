				...
				<div class="page-content-container">
					...
					<div class="page-content-col" id="printPageButton">
			          ...
			          params: "\'value=\' + this.value")}">
											...
											<div class="col-md-3">
												<div
													class="fieldcontain ${hasErrors(bean: filledPostInstance, field: 'employeenames', 'error')} ">
													<label for="Employee Names"> Employe Details</label> <select
														id="staffType" name="employeenames" class="form-control" required>
														<option value="" selected="selected">Select Employe Name/ID
															</option>
														<g:each in="${empnames}" var="empbname">
						<option value="${empbname?.employeeNumber}">
						<th>${empbname?.collagId?.username}</th> -> <th> ${empbname?.deptId?.deptName}</th> -> <th>${empbname?.employeeName} </th> -> <th> ${empbname?.employeeNumber}</th>
