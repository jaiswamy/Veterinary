		...
		<div id="list-position" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="departmentName" title="${message(code: 'position.departmentName.label', default: 'Department Name')}" />
				...
				<g:each in="${positionInstanceList}" status="i" var="positionInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: positionInstance, field: "departmentName")}</td>
