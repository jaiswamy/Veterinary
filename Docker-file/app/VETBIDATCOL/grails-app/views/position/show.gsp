	...
	<body>
		...
		<div id="show-position" class="content scaffold-show" role="main">
			...
			<ol class="property-list position">
				...
				<g:if test="${positionInstance?.departmentName}">
				<li class="fieldcontain">
					<span id="departmentName-label" class="property-label"><g:message code="position.departmentName.label" default="Department Name" /></span>
					
						<span class="property-value" aria-labelledby="departmentName-label"><g:fieldValue bean="${positionInstance}" field="departmentName"/></span>
