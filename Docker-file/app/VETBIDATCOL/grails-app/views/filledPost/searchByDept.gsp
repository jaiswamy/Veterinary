...
<%@page import="com.hiideals.endometric.Usercreation"%>
...
<head>
<meta charset="utf-8" />
<title>URMS | DEPARTMENT REPORTS</title>
						...
						<ul class="nav navbar-nav">
							...
							<sec:ifAnyGranted roles="ROLE_ADMIN">
								...
								<li class="dropdown dropdown-fw dropdown-fw-disabled active open selected"><a
									href="javascript:;" class="text-uppercase"> <img
										src="assets1/layouts/layout5/img/Reportsb.png"> Reports
								</a>
									<ul class="dropdown-menu dropdown-menu-fw">
							...
							<div class="col-md-12">
								<div class="page-head" id="printPageButton">
									<div class="page-title">
										<h3 style="font-size: 25px; color:#2803f3"><b>
											 Search  By College And Department</b></h3><hr style="color:#2803f3;border-top: 2px solid #c49f47;">
									</div>
								</div>
								<div class="m-portlet__body">
									<g:formRemote name="ss1" update="update2"
										url="[action:'searchByDepte']">
										<div class="form-body" id="printPageButton">
											<div class="row">
												<div class="col-md-3">
													<label for="department"> <g:message
															code="postFilled.department.label" default="College Name" />

													</label> <select id="collagId1" name="collagId1"
														class="form-control">
														<g:each in="${user}" var="usrdtl">
															<option value="${usrdtl?.username}">
																${usrdtl?.username}
												...
												<div class="col-md-3">
													<label for="department"> <g:message
															code="postFilled.department.label" default="Department" />

													</label> <select id="department" name="department"
														class="form-control">
														<option value="" selected="selected">Select
															Department</option>
														<option value="Veterinary Anatomy">Veterinary
															Anatomy</option>
														...
														<option value="Veterinary Microbiology">Veterinary
															Microbiology</option>
														<option value="veterinary Pathology">veterinary
															Pathology</option>
														<option value="Animal Genetics & Breeding">Animal
															Genetics & Breeding</option>
														...
														<option value="Livestock Farm Complex">Livestock
															Farm Complex</option>
														<option value="Physical Education">Physical
															Education</option>
														<option value="Fisheries Science">Fisheries
															Science</option>
...
<div class="col-md-3">
			<div
				...
				<label for="staffType"> Staff Type:</label> <select
					id="staffType" name="staffType" class="form-control">
		...
		<%--<div class="col-md-3">
			<div
				...
				<label for="j371"> 371J:</label> <select
					id="j371" name="j371" class="form-control">
					<option value="" selected="selected">Select 371J</option>
