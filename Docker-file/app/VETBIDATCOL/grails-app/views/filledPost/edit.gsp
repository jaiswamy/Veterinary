...
<g:form url="[resource:filledPostInstance, action:'update']" method="PUT" class="horizontal-form">
<g:hiddenField name="version" value="${filledPostInstance?.version}" />
										<fieldset class="form">
											<g:render template="form" />
										</fieldset>
										<div class="form-actions right">
										<g:actionSubmit  class="btn yellow" action="update" value="${message(code: 'default.button.update.label', default: 'Update')}" />
