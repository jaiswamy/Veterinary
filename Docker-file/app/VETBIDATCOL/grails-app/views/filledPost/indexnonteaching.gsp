							...
							<div class="col-md-12">
								...
								<div class="portlet box blue ">
									<div class="portlet-title">
										<div class="caption">
											<i class="fa fa-list"></i> FilledPost Non-Teaching List
										</div>
										<div class="actions">
										...
										<div class="row">
											...
											<div class="col-md-12">
														...
														<table
															...
															<thead>
																...
																<tr>
																	...
																	<th>Employee Pay Scale</th>
																	<th>Social category</th>
																	<th>371J</th>
																	<th>PWD</th>
																	<th>DOE into Present Cadre</th>
																	<th>DOE into Present Payscale</th>
																	<th>Mode Of Entry</th>
																	<th>DOE into One time upgradation</th>
																	<th>Mode Of Entry</th>
																	<th>DOE For  Next Promotion</th>														
																...
																<g:each in="${filledPostInstanceResultss}"
																	...
																	<tr>
																		...
																		<td><a href="javascript:;"
																			...
																			data-target="#downloadss_${i}" data-toggle="modal">
												...
												<g:link action="transferEdit"
																	...
																	<div id="downloadss_${i}" class="modal fade" tabindex="-1">
												...
												<div class="modal-body"
													...
													<g:if test="${filledPostInstance?.outwarddoc}">
														<g:each in="${filledPostInstance?.outwarddoc}" var="dc"
															status="y">
															<div class="margin-top-10" style="text-align: center;">
																<a
																	href="${createLink(controller:'filledPost', action:'downloadFile', id:dc?.id)}"
																	target="_blank"><img
																	src="assets1/layouts/layout2/img/inwardpdf-removebg-preview.png">
																	<br>${dc?.docName}</a>
															</div>
														</g:each>
													</g:if>
												...
												<div class="modal-footer">
													<button type="button" data-dismiss="modal"
														...
														<div class="text-center">
															<g:link action="filereportnontech"
