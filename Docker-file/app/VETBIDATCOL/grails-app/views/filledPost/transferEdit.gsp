							...
							<div class="col-md-12">
								...
								<div class="portlet box blue ">
									<div class="portlet-title">
										<div class="caption">
											<i class="fa fa-gift"></i> Transfer One College to Others College
										</div>
...
<g:form url="[resource:filledPostInstance, action:'transferUpdate']" method="PUT" class="horizontal-form">
<g:hiddenField name="version" value="${filledPostInstance?.version}" />
										<fieldset class="form">
											<g:render template="form" />
										</fieldset>
										<div class="form-actions right">
										<g:actionSubmit  class="btn yellow" action="transferUpdate" value="${message(code: 'default.button.update.label', default: 'Transfer')}" />
