...
class gsp_universityResearchManagementSystem_transferPost_userDetailsss_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/transferPost/_userDetailsss.gsp" }
public Object run() {
Writer out = getOut()
