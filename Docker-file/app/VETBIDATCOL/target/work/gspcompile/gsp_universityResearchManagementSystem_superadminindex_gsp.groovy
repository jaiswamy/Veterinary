...
class gsp_universityResearchManagementSystem_superadminindex_gsp extends GroovyPage {
...
printHtmlPart(7)
invokeTag('render','g',99,['template':("/header/leftSide"),'model':([activ:[adminssion:'start active open']])],-1)
printHtmlPart(8)
...
invokeTag('formRemote','g',213,['name':("kk"),'url':([action:'createadmin']),'update':("update1"),'class':("horizontal-form")],3)
printHtmlPart(14)
loop:{
int i = 0
...
createTagBody(4, {->
printHtmlPart(25)
invokeTag('hiddenField','g',285,['name':("userListid"),'value':(usersInstance?.id)],-1)
printHtmlPart(26)
invokeTag('submitButton','g',289,['name':("Edit"),'class':("btn btn-primary")],-1)
printHtmlPart(27)
})
invokeTag('formRemote','g',291,['name':("kk"),'url':([action:'adminEdit']),'update':("update1")],4)
printHtmlPart(28)
i++
}
}
...
invokeTag('ifAnyGranted','sec',301,['roles':("ROLE_SUPERADMIN")],2)
printHtmlPart(30)
invokeTag('render','g',319,['template':("/header/footer")],-1)
printHtmlPart(31)
})
invokeTag('captureBody','sitemesh',381,['class':("page-header-fixed page-sidebar-closed-hide-logo")],1)
printHtmlPart(32)
}
...
public static final long LAST_MODIFIED = 1653463898000L
