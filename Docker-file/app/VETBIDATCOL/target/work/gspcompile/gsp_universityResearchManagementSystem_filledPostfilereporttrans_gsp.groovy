...
class gsp_universityResearchManagementSystem_filledPostfilereporttrans_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/filledPost/filereporttrans.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(9)
invokeTag('formatDate','g',195,['date':(filledPostInstance.doeAssistantProfessorKVAFSU),'format':("dd-MM-yyyy")],-1)
printHtmlPart(10)
...
public static final long LAST_MODIFIED = 1653463636000L
