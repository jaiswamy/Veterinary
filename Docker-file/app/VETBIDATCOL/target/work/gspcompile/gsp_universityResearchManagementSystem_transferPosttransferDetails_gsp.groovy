...
class gsp_universityResearchManagementSystem_transferPosttransferDetails_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/transferPost/transferDetails.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(20)
expressionOut.print(hasErrors(bean: filledPostInstance, field: 'employeenames', 'error'))
printHtmlPart(21)
for( empbname in (empnames) ) {
printHtmlPart(22)
expressionOut.print(empbname?.employeeNumber)
printHtmlPart(23)
expressionOut.print(empbname?.collagId?.username)
printHtmlPart(24)
expressionOut.print(empbname?.deptId?.deptName)
printHtmlPart(25)
expressionOut.print(empbname?.employeeName)
printHtmlPart(26)
expressionOut.print(empbname?.employeeNumber)
printHtmlPart(27)
}
printHtmlPart(28)
invokeTag('submitButton','g',279,['name':("Search"),'class':("btn yellow"),'style':("margin-top: 25px")],-1)
printHtmlPart(29)
})
invokeTag('formRemote','g',287,['name':("ss1"),'update':("update2"),'url':([action:'searchByTrnsfer'])],2)
printHtmlPart(30)
invokeTag('render','g',307,['template':("/header/footer"),'id':("printPageButton")],-1)
printHtmlPart(31)
})
invokeTag('captureBody','sitemesh',442,['class':("page-header-fixed page-sidebar-closed-hide-logo")],1)
printHtmlPart(32)
}
...
public static final long LAST_MODIFIED = 1653463932000L
