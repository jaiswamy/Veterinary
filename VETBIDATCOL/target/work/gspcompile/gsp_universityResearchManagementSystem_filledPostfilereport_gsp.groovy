...
class gsp_universityResearchManagementSystem_filledPostfilereport_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/filledPost/filereport.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(9)
invokeTag('formatDate','g',196,['date':(filledPostInstance.doeAssistantProfessorKVAFSU),'format':("dd-MM-yyyy")],-1)
printHtmlPart(10)
invokeTag('formatDate','g',200,['date':(filledPostInstance.doeProfessorCAS),'format':("dd-MM-yyyy")],-1)
printHtmlPart(11)
expressionOut.print(fieldValue(bean: filledPostInstance, field: "professor"))
printHtmlPart(9)
invokeTag('formatDate','g',207,['date':(filledPostInstance.doePresentCadre),'format':("dd-MM-yyyy")],-1)
printHtmlPart(12)
expressionOut.print(fieldValue(bean: filledPostInstance, field: "present"))
printHtmlPart(9)
invokeTag('formatDate','g',215,['date':(filledPostInstance.dateofRetirement),'format':("dd-MM-yyyy")],-1)
printHtmlPart(12)
...
invokeTag('captureBody','sitemesh',297,['class':("page-header-fixed page-sidebar-closed-hide-logo page-content-white")],1)
printHtmlPart(15)
}
...
public static final long LAST_MODIFIED = 1653463630000L
