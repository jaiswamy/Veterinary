...
class gsp_universityResearchManagementSystem_filledPostsearchByCollage_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/filledPost/searchByCollage.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(42)
invokeTag('submitButton','g',375,['name':("Search"),'class':("btn yellow"),'style':("margin-top: 25px")],-1)
printHtmlPart(43)
})
invokeTag('formRemote','g',381,['name':("ss1"),'update':("update2"),'url':([action:'searchByCollages'])],2)
printHtmlPart(44)
invokeTag('render','g',391,['template':("/header/footer"),'id':("printPageButton")],-1)
printHtmlPart(45)
})
invokeTag('captureBody','sitemesh',486,['class':("page-header-fixed page-sidebar-closed-hide-logo")],1)
printHtmlPart(46)
}
...
public static final long LAST_MODIFIED = 1653463704000L
