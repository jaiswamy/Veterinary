...
class gsp_universityResearchManagementSystem_filledPostfilereportnontech_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/filledPost/filereportnontech.gsp" }
public Object run() {
Writer out = getOut()
...
invokeTag('captureBody','sitemesh',299,['class':("page-header-fixed page-sidebar-closed-hide-logo page-content-white")],1)
printHtmlPart(18)
}
...
public static final long LAST_MODIFIED = 1653463626000L
