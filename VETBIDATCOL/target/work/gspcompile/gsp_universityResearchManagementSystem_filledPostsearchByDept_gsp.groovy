...
class gsp_universityResearchManagementSystem_filledPostsearchByDept_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/filledPost/searchByDept.gsp" }
public Object run() {
Writer out = getOut()
...
createTagBody(2, {->
printHtmlPart(37)
invokeTag('message','g',362,['code':("postFilled.department.label"),'default':("College Name")],-1)
printHtmlPart(38)
for( usrdtl in (user) ) {
printHtmlPart(39)
...
printHtmlPart(42)
invokeTag('message','g',376,['code':("postFilled.department.label"),'default':("Department")],-1)
printHtmlPart(43)
expressionOut.print(hasErrors(bean: filledPostInstance, field: 'staffType', 'error'))
printHtmlPart(44)
invokeTag('submitButton','g',455,['name':("Search"),'class':("btn yellow"),'style':("margin-top: 25px")],-1)
printHtmlPart(45)
})
invokeTag('formRemote','g',463,['name':("ss1"),'update':("update2"),'url':([action:'searchByDepte'])],2)
printHtmlPart(46)
invokeTag('render','g',473,['template':("/header/footer"),'id':("printPageButton")],-1)
printHtmlPart(47)
})
invokeTag('captureBody','sitemesh',568,['class':("page-header-fixed page-sidebar-closed-hide-logo")],1)
printHtmlPart(48)
}
...
public static final long LAST_MODIFIED = 1741618593757L
