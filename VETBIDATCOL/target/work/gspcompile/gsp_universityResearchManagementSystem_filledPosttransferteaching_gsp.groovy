...
class gsp_universityResearchManagementSystem_filledPosttransferteaching_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/filledPost/transferteaching.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(42)
invokeTag('formatDate','g',439,['date':(filledPostInstance.doeAssistantProfessorKVAFSU),'format':("dd-MM-yyyy")],-1)
printHtmlPart(43)
invokeTag('formatDate','g',441,['date':(filledPostInstance.doeProfessorCAS),'format':("dd-MM-yyyy")],-1)
printHtmlPart(44)
expressionOut.print(fieldValue(bean: filledPostInstance, field: "professor"))
printHtmlPart(45)
invokeTag('formatDate','g',449,['date':(filledPostInstance.doePresentCadre),'format':("dd-MM-yyyy")],-1)
printHtmlPart(46)
expressionOut.print(fieldValue(bean: filledPostInstance, field: "present"))
printHtmlPart(47)
invokeTag('formatDate','g',457,['date':(filledPostInstance.dateofRetirement),'format':("dd-MM-yyyy")],-1)
printHtmlPart(46)
...
invokeTag('link','g',473,['action':("filereporttrans"),'class':("btn btn blue btn-primary"),'target':("_blank")],2)
printHtmlPart(51)
invokeTag('render','g',497,['template':("/header/footer")],-1)
printHtmlPart(52)
})
invokeTag('captureBody','sitemesh',564,['class':("page-header-fixed page-sidebar-closed-hide-logo")],1)
printHtmlPart(53)
}
...
public static final long LAST_MODIFIED = 1653463734000L
