...
class gsp_universityResearchManagementSystem_registerindex_gsp extends GroovyPage {
...
invokeTag('link','g',110,['controller':("login"),'action':("auth"),'style':("color:white")],2)
printHtmlPart(12)
})
invokeTag('captureBody','sitemesh',214,['class':("bg-dark")],1)
printHtmlPart(13)
}
...
public static final long LAST_MODIFIED = 1644921436000L
