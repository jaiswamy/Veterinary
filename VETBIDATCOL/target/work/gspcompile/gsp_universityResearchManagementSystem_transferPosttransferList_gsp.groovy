...
class gsp_universityResearchManagementSystem_transferPosttransferList_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/transferPost/transferList.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(40)
expressionOut.print(fieldValue(bean: filledPostInstance, field: "fromCollage"))
printHtmlPart(40)
...
printHtmlPart(43)
invokeTag('render','g',450,['template':("/header/footer")],-1)
printHtmlPart(44)
})
invokeTag('captureBody','sitemesh',533,['class':("page-header-fixed page-sidebar-closed-hide-logo")],1)
printHtmlPart(45)
}
...
public static final long LAST_MODIFIED = 1741346545346L
