...
class SuperadminController {
	...
	def indexx() {
		...
		def fillDashboard = Usercreation.findAll()
	...
	def index() {
		...
		//println("#############################"+anidtl)
				...
				//def clgs= Usercreation.findAll
				[usersInstanceList:usersInstanceList,users:users]
			}
	...
	def getusrDt2l(){
		...
		println("clssss")
				...
				println("!!!sggggggggda!!:"+anidtl)
				render(template:'userDetails2',model:[userdet111:anidtl])
			}
}
