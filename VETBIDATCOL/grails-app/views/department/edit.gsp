							...
							<div class="col-md-12">
								...
								<div class="portlet box blue ">
									<div class="portlet-title">
										<div class="caption">
											<i class="fa fa-gift"></i> Create Filled post
										</div>
										<div class="actions">
									...
									<div class="portlet-body form">
										...
										<g:form url="[resource:departmentInstance, action:'updateDepartment']"
											method="PUT" class="horizontal-form">
											<g:hiddenField name="version"
												value="${departmentInstance?.version}" />
											<fieldset class="form">
											...
											<div class="form-actions right">
												<g:actionSubmit action="updateDepartment" name="create"
													class="btn yellow"
...
<![endif]-->
	...
	<script>
		...
		$('select[name=clgId]').change(function(e) {
			if ($('select[name=clgId]').val()) {
				$('#Returntype3').show();
			} else {
				$('#Returntype3').hide();
			}
