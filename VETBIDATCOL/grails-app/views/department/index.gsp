						...
						<ul class="nav navbar-nav">
							...
							<sec:ifAnyGranted roles="ROLE_ADMIN">
								...
								<li class="dropdown dropdown-fw dropdown-fw-disabled  active open selected"><a
									href="javascript:;" class="text-uppercase"><img
										src="assets1/layouts/layout5/img/Departmentb.png">
										Department </a>
									<ul class="dropdown-menu dropdown-menu-fw">
												...
												<div class="portlet light ">
													...
													<div class="portlet-body table-both-scroll">
														<table
															...
															<thead>
																...
																<tr>
																	...
																	<th>Teaching</th>
																	<th>Non-Teaching</th>
																	<th>State Teaching</th>
																	<th>State Non-Teaching</th>
																	<th>KK Teaching</th>
																	<th>KK Non-Teaching</th>
																	<th>Options
																	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
															...
															<tbody>
																<g:each in="${departmentInstanceList}" status="i"
																	...
																	<tr>
																		...
																		<td>
																			${fieldValue(bean: departmentInstance, field: "clgId")}
																		</td>

																		<td>
																			${fieldValue(bean: departmentInstance, field: "deptName")}
																		</td>
																		<td>
																			${fieldValue(bean: departmentInstance, field: "teaching")}
																		</td>

																		<td>
																			${fieldValue(bean: departmentInstance, field: "nonTeaching")}
																		</td>
																		<td>
																			${fieldValue(bean: departmentInstance, field: "stateTeaching")}
																		</td>

																		<td>
																			${fieldValue(bean: departmentInstance, field: "stateNonTeaching")}
																		</td>
																		<td>
																			${fieldValue(bean: departmentInstance, field: "kkTeaching")}
																		</td>

																		<td>
																			${fieldValue(bean: departmentInstance, field: "kkNonTeaching")}
																		</td>
														...
														<div class="text-center">
															<g:link action="departmentreport"
