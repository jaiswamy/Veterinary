...
<link href="assets1/layouts/layout5/css/themes/default.min.css"
							...
							<sec:ifAnyGranted roles="ROLE_ADMIN">
								<li class="dropdown dropdown-fw dropdown-fw-disabled"><a
									...
									<ul class="dropdown-menu dropdown-menu-fw">
										...
										<li><g:link controller="usercreate" action="index"
												class="nav-link ">
												<i class="fa fa-list"></i> View Collage list
									</g:link></li>
									</ul></li>
							...
							<div class="col-md-12">
								...
								<div class="portlet box blue ">
									<div class="portlet-title">
										<div class="caption">
											<i class="fa fa-list"></i> FilledPost Teaching List
										</div>
										<div class="actions">
											<g:link controller="filledPost" action="create"
												class="btn sbold green btn-sm">
												<i class="fa fa-list"></i>  Create FilledPost
									       </g:link>
										</div>
														...
														<table
															...
															<thead>
																...
																<tr>
																	...
																	<th>DOE Associate Professor</th>
																	<th>Mode Of Entry</th>
																	<th>DOE Professor Cadre</th>
																	<th>Mode Of Entry</th>
															...
															<tbody>
																<g:each in="${filledPostInstanceResults}" status="i"
																	var="filledPostInstance">
																	<tr>
																		<td>
																			${i+1}
																		</td>
																		...
																		<td><a href="javascript:;"
																			...
																			data-target="#download_${i}" data-toggle="modal">
																				<i class="fa fa-share"></i> View PDF
																		</a></td>
																		...
																		<td><sec:ifAnyGranted roles="ROLE_ADMIN">
																				...
																				<g:link action="show" target="_blank"
																					resource="${filledPostInstance}"
																					class="btn btn-outline btn-circle btn-sm purple">
																					<i class="fa fa-edit"></i> View
												</g:link>

																				<g:link action="transferEdit"
																					resource="${filledPostInstance}"
																					class="btn btn-outline btn-circle btn-sm purple">
...
<div id="download_${i}" class="modal fade" tabindex="-1">
												<div class="modal-header">
													<button type="button" class="close" data-dismiss="modal"
														aria-hidden="true"></button>
													<h4 class="modal-title" style="color:#000000;text-align: center;"><b>PDF Download</b></h4>
												</div>
												<div class="modal-body"
													style="overflow: scroll; height: 500px;">
													<g:if test="${filledPostInstance?.docs}">
														<g:each in="${filledPostInstance?.docs}" var="dc"
															status="y">
															<div class="margin-top-10" style="text-align: center;">
																<a
																	href="${createLink(controller:'filledPost', action:'downloadFile', id:dc?.id)}"
																	target="_blank"><img src="assets1/layouts/layout2/img/inwardpdf-removebg-preview.png">
																	<br>${dc?.docName}</a>
															</div>
														</g:each>
													</g:if>
